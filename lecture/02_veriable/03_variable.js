 ...
 * 5. 작성법
 *   1) 초기화 없이 선언만 할 경우 
 *       var|let|const 변수명;  **var 사용 x , let const 사용 
 *   2) 선언과 동시에 초기화 할 경우 
 *       var|let|const 변수명 = 값;
 * 
 * ‼️ 세가지 선언 방법 특징
...
var userId = 'user01'; // 특징2. 재선언 - 가능 (동일스코프에서 중복 선언가능)
userId = 'user02'; //특징3. 재할당 - 가능
console.log(userId);

function varScopeTest(){
  var userPwd = 'pass02'; //function 내에만 사용하는 변수
 ...
 */
 ...
 //2.let
 let userName;
 console.log(userName); //특징1. 할당 전 -undefined
 //특징2. 재선언 - 불가능(동일 스코프 내 중복선언 불가능)
 userName ='홍길동';
...
function letScopeTest(){
  ...
  console.log(userAddr);
   //특징4. scope - 블럭스코프=지역변수

}
letScopeTest();
//3.const - 상수를 선언하기 위해 사용되는 키워드 *상수 = 항상 똑같은 수 

//const userHoddy; //특징1. 할당 전 - 사용 불가능(초기화를 해야만 사용 가능)
const userHobby = '요리'; //특징2. 재선언 - 불가능
userHobby = '등산';
console.log(userHobby); //특징3. 재할당 - 불가능
// 특징4. scope - 블럭스코프 = 지역변수
