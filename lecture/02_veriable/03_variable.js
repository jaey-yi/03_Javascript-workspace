...
/*
 * 4. 변수 선언 방법
 *   var 특징1. 할당 전 - undefined (초기화 없이 선언 가능) / 특징2. 재선언 - 가능 (동일스코프에서 중복 선언가능)
 *   let
 *   const */
// 1. 
var userId;
 ...
 * │ const │ 블럭 스코프 │ 불가능 │ 사용 불가능 │ 불가능 │   상수    │
 * └───────┴─────────────┴────────┴─────────────┴────────┴─────────── */
/** * var  : 자유도 높고 중복 사용 가능 > 변경 가능성 
/** let, const : 변경 없고 const 는 재할당 불가. 최대한 좁은 스코프
가능한 let const 사용 */
// 호이스팅(hoisting) : 줄 순서 바뀌어도 변수 사용 가능 