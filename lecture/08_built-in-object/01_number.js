...
//순서
//1. 연산 할 배열 전달받기 =>매개변수
//2. 배열에 포함된 요소들 순회하기 => for문 forEach
//3. 숫자요소 거르기 => isNaN 또는 조건문
//4. 정수변환해서 총합 구하기 => 정수형태로 
console.log("----------------")

const array2 = ['hello', 'world', 10, 20, 30.23, '40', { cpu: 'i7' }, true, false, () => {}] ;
...
function gettotal(array){
    ...
    array.filter(item => /[0-9]+/.test(item) )
         .forEach(item => (total2 += Number.parseInt(item)));
    
  return total2;
};

console.log(gettotal(array2));
